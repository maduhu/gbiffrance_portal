...
//"<span><b></b></span> <span>Type: <b>Chine</b></span>  <span>Pays: <b>Pays</b></span>  <span id=\"place_bbox\" style=\"display:none\">Pays</span>"
    ...
    var my_text_array=val.split('<span>')     
       var my_taxa=my_text_array[0].substring(0,my_text_array[0].length-1)
...
taxa_level=taxa_level[1].substring(0,taxa_level[1].length-1);
   ...
   my_text='<li><i class="icon-trash" style="color:#9C0890;"></i><b>'+my_taxa+'</b> <span>'+taxa_level+'</span></li>';
val=my_text;
...
my_text='<li><i class="icon-trash" style="color:#9C0890;float:left;"></i><i class="icon-eye-open" style="color:blue"></i><b>'+_this.eq(0).html()+'</b>  Type : '+_this.eq(1).html()+' Country : '+_this.eq(2).html()+'<span  class="bbox_handler">'+_this.eq(3).html()+'</span></li>'
...
$('#taxa-dropdown ul').append(selected_text);
...
$('#places-dropdown ul').append(selected_text);

var count=$('#places-dropdown li').size()

$('#places-dropdown-trigger').html('Places  <span class="badge badge-warning">'+count+'</span>').trigger('click')
