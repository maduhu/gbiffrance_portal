...
//			console.warn(geojson.features) 
		...
		var isFeature = (geojson.type === 'Feature'),
			...
			layer = L.GeoJSON.geometryToLayer(geometry, this.options.pointToLayer,id);
//console.info(id)
...
L.Util.extend(L.GeoJSON, {
	...
	geometryToLayer: function (geometry, pointToLayer,id) {
//		console.log(geometry)
		...
		case 'Polygon':
			...
			var data=new L.Polygon(latlngs)
//			data._leaflet_id = id;
